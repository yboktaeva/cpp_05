...
/*   Updated: 2023/12/04 16:49:13 by yuboktae         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Bureaucrat::incrementGrade() {
    std::cout << "Try to increment grade for " << this->getName() << std::endl;
    if (this->_grade - 1 < 1)
        throw Bureaucrat::GradeTooHighException();
    this->_grade--;
}
...
void Bureaucrat::decrementGrade() {
    std::cout << "Try to decrement grade for " << this->getName() << std::endl;
