...
/*   Updated: 2023/12/06 19:42:01 by yuboktae         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Bureaucrat::incrementGrade() {
    std::cout << CYAN << "Try to increment grade for " << this->getName() << RESET << std::endl;
    if (this->_grade - 1 < 1)
        throw Bureaucrat::GradeTooHighException();
    this->_grade--;
}
...
void Bureaucrat::decrementGrade() {
    std::cout << CYAN << "Try to decrement grade for " << this->getName() << RESET << std::endl;
